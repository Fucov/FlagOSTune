#!/usr/bin/env bash
#
# bench-vllm-patches-w8a8-router-mm-gems-null-flagtune.sh - Benchmark selected
# vLLM patches with GEMS NULL mode and USE_FLAGTUNE=1.
#
# Usage:
#   ./scripts/bench-vllm-patches-w8a8-router-mm-gems-null-flagtune.sh
#   ./scripts/bench-vllm-patches-w8a8-router-mm-gems-null-flagtune.sh --dry-run
#
